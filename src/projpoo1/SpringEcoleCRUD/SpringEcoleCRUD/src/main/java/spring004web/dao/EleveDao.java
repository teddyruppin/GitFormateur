...
public class EleveDao implements IEleveDao {
	...
	public void modifierEleve(Eleves eEleves) {
		...
		lCriteriaUpdate.set("nom", eEleves.getNom());
		lCriteriaUpdate.set("prenom", eEleves.getPrenom());
		lCriteriaUpdate.set("classe", eEleves.getClasse());
		lCriteriaUpdate.set("date_naissance", eEleves.getDate_naissance());
		lCriteriaUpdate.set("adresse", eEleves.getAdresse());
		lCriteriaUpdate.set("sexe", eEleves.getSexe());
