...
public class Programme {
	...
	public static void main(String[] args) {
		...
		/**
		 * int, boolean, float sont des types de variables non objet = primitive String,
		 * Integer, Long, Double, Float sont des types objets
		 * 
		 */

		/**
		 * Date madate; Object o1 = new Object(); int i1=23; madate = new Date();
		 * System.out.println(2*i1); System.out.println(madate); System.out.println(o1);
		 */
	...
	public void atelier03() {
		...
		System.out.println("votre nom est " + nom + ", votre pr�nom est " + prenom + " et vous avez " + age + " ans.");
		sc.close();
	}
